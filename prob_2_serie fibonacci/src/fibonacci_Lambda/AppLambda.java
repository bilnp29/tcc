...
public class AppLambda extends JFrame {
	...
	private JTextField textField_ResutFibo;
	...
	public AppLambda() {
		...
		JLabel lblinfoCalculo_2 = new JLabel("m\u00E9todo recursivo express\u00F5es lambdas.");
		...
		textField_ResutFibo = new JTextField();
		textField_ResutFibo.setEditable(false);
		textField_ResutFibo.setBounds(101, 157, 212, 20);
		contentPane.add(textField_ResutFibo);
		textField_ResutFibo.setColumns(10);

		FiboLambda fl = new FiboLambda();

		JButton btnCalcularC = new JButton("Calcular - L");
